 ...
 * Use the [AdminShipmentListFragment.newInstance] factory method to
...
class AdminShipmentListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminShipmentListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminShipmentListFragment().apply {
