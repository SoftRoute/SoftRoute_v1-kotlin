 ...
 * Use the [AdminEditConsigneeFragment.newInstance] factory method to
...
class AdminEditConsigneeFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminEditConsigneeFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminEditConsigneeFragment().apply {
